...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-04-2025 a las 22:03:44
...
CREATE TABLE `hilos` (
  ...
  `ruta_foto_hilo` varchar(255) DEFAULT NULL,
  `creado` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `comentarios`
  ADD CONSTRAINT `comentarios_ibfk_1` FOREIGN KEY (`id_hilo`) REFERENCES `hilos` (`id`),
...
--
ALTER TABLE `hilos`
  ADD CONSTRAINT `hilos_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id`);
COMMIT;
